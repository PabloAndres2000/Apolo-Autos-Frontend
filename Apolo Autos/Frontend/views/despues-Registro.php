...
<body class="size-1280">
  ...
  <a target="_blank" class="hide-s" href="../views/premium1.php" style="position:fixed;top:120px;right:-14px;z-index:10;"><img src="img/premium-features.png" alt=""></a>
  <!-- HEADER -->
      ...
      <div class="top-nav">
        ...
        <div class="logo hide-l hide-xl hide-xxl">
          <a href="index.html" class="logo">
            <!-- Logo White Version -->
            <img class="logo-white" src="./assets/images/apoloVentaAutos.png.png" alt="">
            <!-- Logo Dark Version -->
        ...
        <div class="top-nav left-menu">
          <ul class="right top-ul chevron">
            ...
            <li><a href="./views/premium1.php">Premium</a></li>
          </ul>
        </div>
        ...
        <div class="top-nav right-menu">
          <ul class="top-ul chevron">
            <li>
            <li><a href="./views/publicarMiAuto.php">Publicar Mi Auto</a></li>
  ...
  <main role="main">
    <!-- Header -->
    <header class="section-top-padding background-image text-center" style="background-image:url(./assets/images/wallpaper.png)">
      <h1 class="text-extra-thin text-white text-s-size-30 text-m-size-40 text-size-50 text-line-height-1 margin-bottom-40 margin-top-130">
        <?php echo "Bienvenido ", $datoUsuario["nombre"]; ?>
      </h1>
      <p style="padding-bottom:400px;" class="text-white">Bienvenido Al Portal Mi Cuenta Apolo Autos<br> !Aca Podras Administrar Tus Publicaciones Segun Tus Necesidades!</p>
